                        ...
                        <tr>
                            ...
                            <th>
                                <div class="dropdown d-inline">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu" aria-labelledby="categoryDropdown" id="categoryFilter">
            ...
            <div class="modal-body">
                <form action="products.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control-lg" id="category_id" name="category_id" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" required>
                            <div class="dropdown-menu">
                                <?php if ($categories): ?>
                                    <?php foreach ($categories as $category): ?>
                                        <option class="form-control"value="<?php echo htmlspecialchars($category['category_id']); ?>">
                                            <?php echo htmlspecialchars($category['category_name']); ?>
                                        </option>
                                    <?php endforeach; ?>
                                <?php else: ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" action="update_product.php" method="POST">
                    ...
                    <div class="mb-3">
                    <label for="category_id" class="form-label">Category:</label>
                    <select class=" form-control form-control-lg" id="edit_category_id" name="category_id" required>
                        <?php if ($categories): ?>
                            <?php foreach ($categories as $category): ?>
