    ...
    <div class="main-content" id="main-content">
        ...
        <div class="table-content" id="supplier">
            <section class="table-list">
                <button class="btn btn-primary add-supplier-btn custom-btn float-right" data-bs-toggle="modal" data-bs-target="#addModal">Add Supplier</button>
                <table class="Table">
                    <thead>
                        <tr>
                            <th>ID</th>
                 ...
                 if ($result->num_rows > 0) {
                     while($row = $result->fetch_assoc()) {
                         echo  "<tr data-supplier-id='" . $row["supplier_id"] . "'>
                                 ...
                                 <td>
                                      <button class='btn btn-success editBtn' data-id='" . $row['supplier_id'] . "'>Edit</button> |
                                         <button class='btn btn-danger deleteBtn' data-id='" . $row['supplier_id'] . "'>Delete</button>
                                 </td>
                               </tr>";
                     }
                 } else {
